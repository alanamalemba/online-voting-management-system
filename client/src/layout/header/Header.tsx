...
export default function Header() {
  ...
  return (
    <header className="relative bg-indigo-900 h-[33vh] font-medium text-white ">
      <nav className="absolute left-0 right-0  top-0 z-10 max-w-[80%] mx-auto flex justify-between py-4 border-b border-indigo-600">
      ...
      <div className="py-6 absolute z-10 top-1/4 max-w-[80%] mx-auto left-0 right-0">
